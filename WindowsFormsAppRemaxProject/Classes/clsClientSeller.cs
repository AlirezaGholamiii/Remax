...
namespace WindowsFormsAppRemaxProject
{
    class clsClientSeller
    {
        ...
        public clsClientSeller(string clientID, string name, string title, string phone, string country, string email, clsListHouse houses)
        {
            vClientID = clientID;
            vName = name;
            vTitle = title;
        ...
        public clsClientSeller(string clientID, string name, string title, string phone, string country, string email)
        {
            vClientID = clientID;
            vName = name;
            vTitle = title;
